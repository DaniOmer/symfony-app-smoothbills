...
class InvoiceRepository extends ServiceEntityRepository
{
    ...
    {
        return $this->createQueryBuilder('i')
            ->select('s.uid, s.name, s.price, SUM(qhs.price_without_tax * qhs.quantity) as revenueHT, SUM(qhs.price_with_tax * qhs.quantity) as revenueTTC, SUM(qhs.quantity) AS sales')
            ->join('i.quotation', 'q')
